...
//----------------основные настройки-------------------------
volatile unsigned int data I04_mA =0x333;
volatile unsigned int data I20_mA =0xFFF;

#define	FREQ_MIN	0x0
volatile unsigned char data FREQ_MAX=	100;//Hz
//-----------------------------------------------------------
...
volatile unsigned char data  FREQ_FRAME=20;
//------------------------------------------
#define FRQ_CHNL_1 0
//#define FRQ_CHNL_2 1
//#define FRQ_CHNL_3 2
...
//	IT1=1;
	...
	EEPROM_Read(&temp,0x1,I04_mA_ADDR);
	I04_mA=temp;
	...
	EEPROM_Read(&temp,0x1,I20_mA_ADDR);
	I20_mA=temp;
	...
	EEPROM_Read(&temp,0x1,FREQ_MAX_ADDR);
	FREQ_MAX=temp;
	...
	EEPROM_Read(&temp,0x1,FREQ_FRAME_ADDR);
	FREQ_FRAME=temp;
